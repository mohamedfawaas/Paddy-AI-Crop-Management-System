...
public class WeatherController {
    ...
    public WeatherController(MLClientService mlClient,
    ...
    public ResponseEntity<?> advisory(@RequestBody Map<String, Object> payload,
                                       @AuthenticationPrincipal UserDetails ud) {
        try {
            Map<String, Object> result = mlClient.predictWeather(payload);
            Long predictionId = save(ud, "WEATHER", payload, result);
    ...
    public ResponseEntity<?> history(@AuthenticationPrincipal UserDetails ud) {
        ...
        return ResponseEntity.ok(
                predictionRepo.findByUserAndTypeOrderByCreatedAtDesc(found.get(), "WEATHER"));
    }
