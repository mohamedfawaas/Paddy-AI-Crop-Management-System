...
public class PestController {
    ...
    public PestController(MLClientService mlClient,
    ...
    public ResponseEntity<?> predict(@RequestBody Map<String, Object> payload,
        ...
        try {
            Map<String, Object> result = mlClient.predictPest(payload);
            Long predictionId = save(ud, "PEST", payload, result);
    ...
    public ResponseEntity<?> history(@AuthenticationPrincipal UserDetails ud) {
        ...
        return ResponseEntity.ok(
                predictionRepo.findByUserAndTypeOrderByCreatedAtDesc(found.get(), "PEST"));
    }
