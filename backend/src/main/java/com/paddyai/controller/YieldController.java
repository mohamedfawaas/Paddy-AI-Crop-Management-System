...
public class YieldController {
    ...
    public YieldController(MLClientService mlClient,
    ...
    public ResponseEntity<?> predict(@RequestBody Map<String, Object> payload,
        ...
        try {
            Map<String, Object> result = mlClient.predictYield(payload);
            Long predictionId = save(ud, "YIELD", payload, result);
    ...
    public ResponseEntity<?> history(@AuthenticationPrincipal UserDetails ud) {
        ...
        return ResponseEntity.ok(
                predictionRepo.findByUserAndTypeOrderByCreatedAtDesc(found.get(), "YIELD"));
    }
